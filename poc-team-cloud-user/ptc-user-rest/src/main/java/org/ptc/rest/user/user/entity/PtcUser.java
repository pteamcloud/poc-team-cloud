package org.ptc.rest.user.user.entity;
...
public class PtcUser {
	...
	public Set<PtcProject> getProject_Member() {
		return proj_Member;
	}
	public void setProject_Member(Set<PtcProject> project_Member) {
	...
	public PtcUser(String lastName, String role) {
		super();
		//this.id = id;
		this.lastName = lastName;
		this.role = role;
